// src/pages/peloton/delivery-calendar.js
import { useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import toast from 'react-hot-toast';
import { PackageSearch, CalendarDays } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen bg-gray-100">
      <header className="bg-white shadow-md px-4 py-3 flex items-center gap-3 flex-shrink-0">
        ...
        <div className="flex items-center gap-2 ml-2">
          ...
          <h1 className="text-base font-semibold text-gray-800">Delivery Calendar</h1>
        </div>
      </header>

      <main className="flex-1 overflow-auto flex flex-col items-center justify-center gap-4 text-gray-400">
        <CalendarDays size={48} strokeWidth={1.3} />
        <p className="text-sm font-medium">Delivery Calendar — coming soon</p>
